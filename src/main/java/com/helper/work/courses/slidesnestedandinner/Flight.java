package com.helper.work.courses.slidesnestedandinner;
...
public class Flight
    ...
    /**
     * An inner class, on the other hand, is a non-static type, a particular specimen of a nested class
     * Here FlightIterable is a particular specimen of Flight
     */
    private class FlightIterable implements Iterable<Passenger> {
        ...
        public Iterator<Passenger> iterator() {
            ...
            Arrays.sort(passengers, Comparator.comparing(Passenger::getName));
